$(function () {
	...
	$(".youtube").boxes({
		...
		helper: function (helper) {
			...
			helper.el.mess.html('<iframe width="560" height="315" src="http://www.youtube.com/embed/' + video + '?autoplay=1" frameborder="0" allowfullscreen></iframe>');
			helper.center();
	...
	// demo 2
	$(".alert").boxes('alert', 'Đây là thông báo cho bạn.');
	$(".confirm").boxes('confirm', 'Nhấn một nút bất kỳ!');
	$(".prompt").boxes('prompt', 'Nhập tên của bạn?', 'baivong');
